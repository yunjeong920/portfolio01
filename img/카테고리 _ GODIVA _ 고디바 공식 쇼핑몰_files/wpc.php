...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', '2-9372f30e67eb9fa5a45e97519f3048bb-s1616401860.1411|windows_10|chrome-iol38o', 365);
                return;
            }
        }
        ...
        if (size>3980 || len>45 || !is_wp_uid) {
            if (/^(http|https)$/.test(scheme)) {
                i = new Image();
                i.src = scheme + '://altg.widerplanet.com/delivery/info?dlid=&count=' + len + '&size=' + size + '&is_wp_uid=' + is_wp_uid + '&ti=20354&ga=' + ga + (is_wp_uid === 0 ? '&org_wp_uid=' + encodeURIComponent(wp_uid) : '');
            }
        } else {
            identity.setCookie('_wp_uid', '2-9372f30e67eb9fa5a45e97519f3048bb-s1616401860.1411|windows_10|chrome-iol38o', 365);
        }
